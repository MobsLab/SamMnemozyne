...
% Folders with data
if ~exist('Dir', 'var')
    Dir = '/media/nas5/ProjetERC1/StimMFBWake/M0936/';
end
...
if exist('NeuronClassification.mat')~=2
    [UnitID,AllParamsNew,WFInfo,BestElec,figid] = MakeData_ClassifySpikeWaveforms(W,'/home/mobs/Dropbox/Kteam/',1);
...
MatInfoNeurons(:,2) = firingrates';% if ploto
