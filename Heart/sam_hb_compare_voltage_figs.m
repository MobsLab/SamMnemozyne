...
figure2(1,'Color',[1 1 1], 'rend','painters','pos',[1 1 800 1800],'Name', supertit, 'NumberTitle','off')
    subplot(3,2,1:2)
        ...
        % MFB
        hold on
        h1=shadedErrorBar([5001:ttime*1E4-prebuff],squeeze(squeeze(mfb.ratepre_all_mean{1,1}(5001:end-prebuff))), ...
            squeeze(squeeze(mfb.ratepre_all_std{1,1}(5001:end-prebuff))),clrs_letter{6},1);
        hold on 
        h2=shadedErrorBar([ttime*1E4+postbuff:(ttime*2+stimdelay)*1e4-5000], squeeze(squeeze(mfb.ratepost_all_mean{1,1}(postbuff:end-5000))),...
            squeeze(squeeze(mfb.ratepost_all_std{1,1}(postbuff:end-5000))),clrs_letter{6},1);
...
%             'Color',clrs_default(6,:),'LineWidth',2);
        ...
        % DUAL
        h3=shadedErrorBar([5001:ttime*1E4-prebuff],squeeze(squeeze(dual.ratepre_all_mean{1,3}(5001:end-prebuff))), ...
            squeeze(squeeze(dual.ratepre_all_std{1,3}(5001:end-prebuff))),clrs_letter{1},1);
        hold on 
        h4=shadedErrorBar([ttime*1E4+postbuff:(ttime*2+stimdelay)*1e4-5000], squeeze(squeeze(dual.ratepost_all_mean{1,3}(postbuff:end-5000))),...
            squeeze(squeeze(dual.ratepost_all_std{1,3}(postbuff:end-5000))),clrs_letter{1},1);
...
%             'Color',clrs_default(7,:),'LineWidth',2);
        ...
        legend([h1.mainLine h3.mainLine],{'MFB','Dual'},'Location','SouthEast')
        hold off
     ...
     subplot(3,2,3:4)
        ...
        % MFB
        hold on
        h1=shadedErrorBar([5001:ttime*1E4-prebuff],squeeze(squeeze(mfb.ratepre_all_mean{1,2}(5001:end-prebuff))), ...
            squeeze(squeeze(mfb.ratepre_all_std{1,2}(5001:end-prebuff))),clrs_letter{6},1);
        hold on 
        h2=shadedErrorBar([ttime*1E4+postbuff:(ttime*2+stimdelay)*1e4-5000], squeeze(squeeze(mfb.ratepost_all_mean{1,2}(postbuff:end-5000))),...
            squeeze(squeeze(mfb.ratepost_all_std{1,2}(postbuff:end-5000))),clrs_letter{6},1);
        h1.mainLine.LineWidth = 2;
        h2.mainLine.LineWidth = 2;
...
%         hold on
        % DUAL
        h3=shadedErrorBar([5001:ttime*1E4-prebuff],squeeze(squeeze(dual.ratepre_all_mean{1,2}(5001:end-prebuff))), ...
            squeeze(squeeze(dual.ratepre_all_std{1,2}(5001:end-prebuff))),clrs_letter{1},1);
        hold on 
        h4=shadedErrorBar([ttime*1E4+postbuff:(ttime*2+stimdelay)*1e4-5000], squeeze(squeeze(dual.ratepost_all_mean{1,2}(postbuff:end-5000))),...
            squeeze(squeeze(dual.ratepost_all_std{1,2}(postbuff:end-5000))),clrs_letter{1},1);
        h3.mainLine.LineWidth = 2;
        h4.mainLine.LineWidth = 2;
...
%         hold on
     ...
     subplot(3,2,5:6)
        ...
        % MFB
        hold on
        h1=shadedErrorBar([5001:ttime*1E4-prebuff],squeeze(squeeze(mfb.ratepre_all_mean{1,3}(5001:end-prebuff))), ...
            squeeze(squeeze(mfb.ratepre_all_std{1,3}(5001:end-prebuff))),clrs_letter{6},1);
        hold on 
        h2=shadedErrorBar([ttime*1E4+postbuff:(ttime*2+stimdelay)*1e4-5000], squeeze(squeeze(mfb.ratepost_all_mean{1,3}(postbuff:end-5000))),...
            squeeze(squeeze(mfb.ratepost_all_std{1,3}(postbuff:end-5000))),clrs_letter{6},1);
        h1.mainLine.LineWidth = 2;
        h2.mainLine.LineWidth = 2;
...
%         hold on
        % DUAL
        h3=shadedErrorBar([5001:ttime*1E4-prebuff],squeeze(squeeze(dual.ratepre_all_mean{1,1}(5001:end-prebuff))), ...
            squeeze(squeeze(dual.ratepre_all_std{1,1}(5001:end-prebuff))),clrs_letter{1},1);
        hold on 
        h4=shadedErrorBar([ttime*1E4+postbuff:(ttime*2+stimdelay)*1e4-5000], squeeze(squeeze(dual.ratepost_all_mean{1,1}(postbuff:end-5000))),...
            squeeze(squeeze(dual.ratepost_all_std{1,1}(postbuff:end-5000))),clrs_letter{1},1);
        h3.mainLine.LineWidth = 2;
        h4.mainLine.LineWidth = 2;
