...
function [nb_groups, name_map] = channelmap_Mouse882(folder,toSave)

Nchannels = 37; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M882.mat'; % Name of the output channelmap file
