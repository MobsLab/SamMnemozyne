...
%                 Restrict(beh{i}.CleanAlignedYtsd,and(beh{i}.SessionEpoch.Hab,LocomotionEpoch)),'threshold',0.5);close;
            ...
            [map{b},mapS,stat{b},px,py,FR{b}]=PlaceField_DB(Restrict(Spikes{i}.S{j},beh{i}.SessionEpoch.Hab2),...
                Restrict(beh{i}.AlignedXtsd,beh{i}.SessionEpoch.Hab2),...
                Restrict(beh{i}.AlignedYtsd,beh{i}.SessionEpoch.Hab2),'threshold',0.5, 'plotresults',0);close gcf;
...
% caxis([0 2])
hold on
plot(mazeMap2(:,1),mazeMap2(:,2),'w','LineWidth',3)
plot(ShockZoneMap2(:,1),ShockZoneMap2(:,2),'r','LineWidth',3)
